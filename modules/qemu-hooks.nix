...
in {
  ...
  systemd.services.libvirtd = {
    ...
    preStart = ''
      ...
      mkdir -p /var/lib/libvirt/hooks/qemu.d/win10-{steam,intercom,intercom-710,steam-21H1}/{prepare/begin,release/end}

      ln -sf ${qemuHook} /var/lib/libvirt/hooks/qemu
      for dest in /var/lib/libvirt/hooks/qemu.d/win10-{steam,intercom,intercom-710,steam-21H1}/prepare/begin/start.sh; do
        ln -sf ${win10Setup} $dest
      done
      for dest in /var/lib/libvirt/hooks/qemu.d/win10-{steam,intercom,intercom-710,steam-21H1}/release/end/revert.sh; do
